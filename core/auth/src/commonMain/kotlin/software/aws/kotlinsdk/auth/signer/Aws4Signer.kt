...
import software.aws.kotlin.types.AwsCredentials
import software.aws.kotlin.types.Headers
import software.aws.kotlin.types.HttpRequest
import software.aws.kotlin.types.QueryParameters
import software.aws.kotlin.types.RequestSigningArguments
import software.aws.kotlin.types.SdkException
import software.aws.kotlin.types.Signer
import software.aws.kotlin.types.StringContent
import software.aws.kotlin.utils.isUsingStandardPort
import software.aws.kotlin.utils.toHexString
import software.aws.kotlin.utils.urlEncode
...
private val GENERATED_HEADERS = arrayOf(
    AUTH_HEADER,
    X_AMZ_DATE,
    DATE_HEADER
)
