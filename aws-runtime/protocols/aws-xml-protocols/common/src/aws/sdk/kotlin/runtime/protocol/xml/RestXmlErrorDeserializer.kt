...
internal suspend fun parseRestXmlErrorResponse(payload: ByteArray): GenericXmlErrorDetails {
    ...
    return GenericXmlErrorDetails(details.code, details.message, details.requestId)
}
