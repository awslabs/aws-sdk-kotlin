...
class AwsSigv4SigningMiddlewareTest {
    ...
    private fun buildOperation(streaming: Boolean = false): SdkHttpOperation<Unit, HttpResponse> = SdkHttpOperation.build {
    ...
    @Test
    fun testSignStreamingRequest() = runSuspendTest {
