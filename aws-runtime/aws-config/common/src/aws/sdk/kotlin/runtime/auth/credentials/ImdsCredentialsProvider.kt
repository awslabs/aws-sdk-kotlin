...
private const val PROFILE_PATH: String = "/latest/meta-data/iam/security-credentials"
 ...
 *
 *  When retrieving credentials, a call must first be made to
 * `<IMDS_BASE_URL>/latest/meta-data/iam/security-credentials`. This returns the instance
 * profile used. If [profileOverride] is set, the initial call to retrieve the profile is skipped
 * and the provided value is used instead.
 *
 * @param profileOverride override the
 * [instance profile](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.html#ec2-instance-profile) used for this provider
