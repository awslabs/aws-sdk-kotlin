...
abstract class AwsHttpBindingProtocolGenerator : HttpBindingProtocolGenerator() {
    ...
    override fun renderThrowOperationError(
        ...
        listOf(
            ...
            SdkRuntimeTypes.Http.setAseErrorMetadata,
        ...
        writer.write("""val payload = response.body.readAll()""")
            ...
            .withBlock("} catch (ex: Exception) {", "}") {
                withBlock("""throw #T("failed to parse response as ${ctx.protocol.name} error", ex).also {""", "}", SdkRuntimeTypes.Core.UnknownServiceErrorException) {
                    write("#T(it, wrappedResponse, null)", SdkRuntimeTypes.Http.setAseErrorMetadata)
                }
            }
            .write("")
        ...
        if (op.errors.isEmpty()) {
            ...
            writer.write("")
                ...
                .write("#T(modeledException, wrappedResponse, errorDetails)", SdkRuntimeTypes.Http.setAseErrorMetadata)
