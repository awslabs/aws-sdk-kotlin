...
public interface TableSpec<T> {
    ...
    /**
     * A specialization of [TableSpec] for a table with a primary key consisting of a single partition key
     */
    ...
    /**
     * A specialization of [TableSpec] for a table with a primary key that is a composite of a partition key and a sort
     * key
     */
