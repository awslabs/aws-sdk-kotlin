...
class ScalarConvertersTest : ValueConvertersTest() {
    @Test
    fun testBooleanConverter() = given(BooleanConverter.Default) {
        true inDdbIs theSame
        false inDdbIs theSame
    }

    @Test
    fun testByteArrayConverter() = given(ByteArrayConverter.Default) {
    ...
    @Test
    fun testByteConverter() = given(ByteConverter.Default) {
    ...
    @Test
    fun testCharArrayConverter() = given(CharArrayConverter.Default) {
        charArrayOf() inDdbIs ""
        charArrayOf('G', 'u', 'i', 'n', 'e', 'a', ' ', 'p', 'i', 'g') inDdbIs "Guinea pig"
    }

    @Test
    fun testCharConverter() = given(CharConverter.Default) {
        '!' inDdbIs "!"
        'X' inDdbIs "X"
        '7' inDdbIs "7"
    }
    ...
    @Test
    fun testDoubleConverter() = given(DoubleConverter.Default) {
    ...
    @Test
    fun testFloatConverter() = given(FloatConverter.Default) {
    ...
    @Test
    fun testIntConverter() = given(IntConverter.Default) {
        0 inDdbIs theSame
    ...
    @Test
    fun testLongConverter() = given(LongConverter.Default) {
    ...
    @Test
    fun testShortConverter() = given(ShortConverter.Default) {
    ...
    @Test
    fun testUByteConverter() = given(UByteConverter.Default) {
        1.toUByte() inDdbIs 1
    ...
    @Test
    fun testUIntConverter() = given(UIntConverter.Default) {
        0u inDdbIs 0
    ...
    @Test
    fun testULongConverter() = given(ULongConverter.Default) {
    ...
    @Test
    fun testUShortConverter() = given(UShortConverter.Default) {
