...
/**
 * Specifies the attribute name for a property in a [DdbItem]-annotated class/interface. If this annotation is not
...
/**
 * Specifies that this property is the primary key for the item. Every top-level [DdbItem] to be used in a table must
 * have exactly one partition key.
 */
@Target(AnnotationTarget.PROPERTY)
public annotation class DdbPartitionKey

/**
 * Specifies that this property is the sort key for the item. Every top-level [DdbItem] to be used in a table may have
